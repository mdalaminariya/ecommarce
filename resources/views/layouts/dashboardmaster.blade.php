...
<head>
    <meta charset="utf-8" />
    <title>Dashboard | Aranoz - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="main-menu">
            ...
            <div class="logo-box">
                ...
                <a class='logo-light' href='{{ route('frontend') }}'>
                    <img src="{{ asset('dashboard') }}/assets/images/logo.png" alt="logo" class="logo-lg" height="28">
                    <img src="{{ asset('dashboard') }}/assets/images/logo.png" alt="small logo" class="logo-sm" height="28">
                </a>

                <!-- Brand Logo Dark -->
                <a class='logo-dark' href='{{ route('frontend') }}'>
                    <img src="{{ asset('dashboard') }}/assets/images/logo.png" alt="dark logo" class="logo-lg" height="28">
                    <img src="{{ asset('dashboard') }}/assets/images/logo.png" alt="small logo" class="logo-sm" height="28">
                </a>
            </div>
            ...
            <div data-simplebar>
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{ route('dashboard.home') }}'>
                    ...
                    <li class="menu-title">Management & Permission</li>
                    ...
                    <li class="menu-item">
                        <a href="#menuManagement" data-bs-toggle="collapse" class="menu-link waves-effect waves-light">
                            ...
                            <span class="menu-text"> Assign User & Role </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="menuManagement">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='{{ route('home.management') }}'>
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuCategory">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a class='menu-link' href='{{ route('home.category') }}'>
                    ...
                    <ul class="topbar-menu d-flex align-items-center gap-4">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                <img src="{{ asset('uploads/defualt') }}/{{ auth()->user()->image }}" alt="user-image" class="rounded-circle">
                                @else
